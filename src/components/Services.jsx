    ...
    <Sections id="how-to-use">
      <div className="container">
        ...
        <div className="relative">
          {/* Service-01 */}
          <div
            className="relative z-1 flex items-center h-[39rem] mb-5 pd-8 
            border border-n-1/10 rounded-3xl overflow-hidden lg:pd-20 xl:h-[46rem]"
          >
            ...
            <Generating
              className="absolute left-4 right-4 bottom-4 border-n-1/10 border lg:left-1/2 lg-right-auto
